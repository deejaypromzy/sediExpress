...
public class AgentCompleteFragment extends Fragment {
...
//Initialize the ArrayList that will contain the data
    ...
    private void showData(DataSnapshot dataSnapshot) {
        ...
        for (DataSnapshot ds : dataSnapshot.getChildren()) {
            ...
            if (Objects.equals(userDatabase.getStatus(), Utils.COMPLETE) && Objects.equals(userDatabase.getAgent(), user.getUid()))
