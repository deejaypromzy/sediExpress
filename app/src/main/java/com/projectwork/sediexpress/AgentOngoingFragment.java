...
public class AgentOngoingFragment extends Fragment {
...
//Initialize the ArrayList that will contain the data
    ...
    private void showData(DataSnapshot dataSnapshot) {
        ...
        for (DataSnapshot ds : dataSnapshot.getChildren()) {
            ...
            userDatabase.setAgent((ds.getValue(RequestModel.class)).getAgent());
            ...
            if (Objects.equals(userDatabase.getStatus(), Utils.PAID) || Objects.equals(userDatabase.getStatus(), Utils.APPROVED))
                if (Objects.equals(userDatabase.getAgent(), user.getUid())) {
                    ModelFaq.add(new RequestModel(userDatabase.get_id(), userDatabase.getId(), userDatabase.getPickup(), userDatabase.getDrop(), userDatabase.getDistance(),
                            userDatabase.getAmount(), userDatabase.getRecipient(), userDatabase.getRecipient_phone(), userDatabase.getDesc(), userDatabase.getDate(), userDatabase.getStatus(), userDatabase.getSecreteCode()));
                }
        }
